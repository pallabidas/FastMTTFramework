	...
	std::cout<<"ici!!!!"<<std::endl;
	 ...
	 if (doES>0){
		...
		if (year==2016){
		    ...
		    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)<1.5) ES_UP_scale=1.00806; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)<1.5) ES_UP_scale=1.01168; // for e fakes
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)>1.5) ES_UP_scale=1.01808; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)>1.5) ES_UP_scale=1.06570; // for e fakes
		}
		else if (year==2017){
                    ...
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)<1.5) ES_UP_scale=1.01343; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)<1.5) ES_UP_scale=1.02162; // for e fakes
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)>1.5) ES_UP_scale=1.02249; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)>1.5) ES_UP_scale=1.06461;
                }
		else if (year==2018){
                    ...
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)<1.5) ES_UP_scale=1.00904; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)<1.5) ES_UP_scale=1.01226; // for e fakes
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)>1.5) ES_UP_scale=1.03404; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)>1.5) ES_UP_scale=1.05499;
                }
                double pt2_UP;
                double mass2_UP=m2;
               ...
               runSVFit(measuredTauLeptonsUP, metcorr_ex_UP, metcorr_ey_UP, covMET, 0, svFitMass_UP, svFitPt_UP, svFitEta_UP, svFitPhi_UP);
                ...
                if (gen_match_2<5) ES_DOWN_scale=0.99; // e and mu fakes
                if (year==2016){
                    ...
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)<1.5) ES_DOWN_scale=0.99018; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)<1.5) ES_DOWN_scale=0.97525; // for e fakes
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)>1.5) ES_DOWN_scale=0.98898; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)>1.5) ES_DOWN_scale=0.94306;
                }
                else if (year==2017){
                    ...
                    else if (doES==1 && gen_match_2==5 && decayMode2==11) ES_DOWN_scale=0.991; // for real taus
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)<1.5) ES_DOWN_scale=0.99118; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)<1.5) ES_DOWN_scale=0.99027; // for e fakes
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)>1.5) ES_DOWN_scale=0.98570; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)>1.5) ES_DOWN_scale=0.95031;
                }
                else if (year==2018){
                    ...
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)<1.5) ES_DOWN_scale=0.99526; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)<1.5) ES_DOWN_scale=0.98402; // for e fakes
                    else if (gen_match_2<5 && decayMode2==0 && fabs(eta2)>1.5) ES_DOWN_scale=0.98750; // for e fakes
                    else if (gen_match_2<5 && decayMode2==1 && fabs(eta2)>1.5) ES_DOWN_scale=0.95691;
                }
                double pt2_DOWN;
