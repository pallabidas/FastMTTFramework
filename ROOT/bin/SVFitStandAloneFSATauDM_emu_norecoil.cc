...
void readdir(TDirectory *dir, optutl::CommandLineParser parser, char TreeToUse[], int doES, int doUES, int doRES, int doJES, int year) 
{
  ...
  while ((key = (TKey*)next())) {
	...
	std::cout<<"ici!!!!"<<std::endl;
      ...
      TBranch *newBranchPt1ESCU = t->Branch("pt_sv_elescaleESUp", &svFitPt_ESCALEUP, "pt_sv_elescaleESUp/F");
      TBranch *newBranchPt1ESCD = t->Branch("pt_sv_elescaleESDown", &svFitPt_ESCALEDOWN, "pt_sv_elescaleESDown/F");
      ...
      TBranch *newBranchEta1ESCU = t->Branch("eta_sv_elescaleESUp", &svFitEta_ESCALEUP, "eta_sv_elescaleESUp/F");
      TBranch *newBranchEta1ESCD = t->Branch("eta_sv_elescaleESDown", &svFitEta_ESCALEDOWN, "eta_sv_elescaleESDown/F");
      ...
      TBranch *newBranchPhi1ESCU = t->Branch("phi_sv_elescaleESUp", &svFitPhi_ESCALEUP, "phi_sv_elescaleESUp/F");
      TBranch *newBranchPhi1ESCD = t->Branch("phi_sv_elescaleESDown", &svFitPhi_ESCALEDOWN, "phi_sv_elescaleESDown/F");
	 ...
	 if (doES>0){
		...
		//#################################################
             ...
             if (doES==2){ // embedded
                if (fabs(eta1)<1.479) ES_DOWN_scale=0.9950;
